...
![Frigate Vision: violet eye with wings](custom_components/frigate_vision/brand/icon.png)
...
`0.3.7` is the current stable release and introduces the violet winged-eye
